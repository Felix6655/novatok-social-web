...
// Uses localStorage for room history and user preferences

const RECENT_ROOMS_KEY = 'novatok_recent_rooms'
const ROOM_MESSAGES_PREFIX = 'novatok_room_messages_'
const DISPLAY_NAME_KEY = 'novatok_rooms_display_name'
...
/**
 * Generate a unique identity for LiveKit
 * @returns {string}
 */
...
export function getUserIdentity() {
  ...
  const key = 'novatok_rooms_identity'
